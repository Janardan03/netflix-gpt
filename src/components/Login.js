...
const Login = () => {
  ...
  return (
    <div>
        ...
        <form onSubmit={(e) => {e.preventDefault()}} className="w-11/12 md:w-3/12 absolute p-12 bg-black my-40 md:my-36 mx-auto left-0 right-0 text-white rounded-lg bg-opacity-80">
